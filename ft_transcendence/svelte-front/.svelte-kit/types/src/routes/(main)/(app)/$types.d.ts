...
type LayoutRouteId = RouteId | "/(main)/(app)" | "/(main)/(app)/channels" | "/(main)/(app)/channels/[id]" | "/(main)/(app)/channels/create" | "/(main)/(app)/friends" | "/(main)/(app)/parameters" | "/(main)/(app)/postgame" | "/(main)/(app)/profile/[username]" | "/(main)/(app)/users"
